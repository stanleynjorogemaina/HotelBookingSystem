...
<html lang="en">
 <head>
    ...
    <title>SERENADE HOTEL-HOME</title>
        ...
        <div class="swiper swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="images/home.jpg" class="w-100 d-block">
            </div>
            <div class="swiper-slide">
          ...
          <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
            <div class="swiper-slide bg-white p-4">
              <div class="profile d-flex align-items-center mb-3">
                ...
                <h6 class="m-2 ms-2">Jane Njeri</h6>
              </div>
              <p>
              texh here
                <div class="rating">
          ...
          <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
            <div class="swiper-slide bg-white p-4">
              <div class="profile d-flex align-items-center mb-3">
                ...
                <h6 class="m-2 ms-2">John Kamau</h6>
              </div>
              <p>
                text here..
              </p>
...
//         if (age < 18) {
//             document.getElementById("ageError").innerText = "You must be 18 years or older.";
//             // You may choose to clear the date input or take other actions
//         } else {
