...
//             echo 'inactive';
//         } else {
//             // Accept any password condition
//             // Replace this condition with your specific requirements for accepting any password
//             // For example, remove the condition and directly proceed to session creation
//             // if you want to accept any password
//             if (true) {
//                 // Regenerate the session ID
//                 session_regenerate_id(true);
