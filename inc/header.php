      ...
      <?php
        ...
        else
        {
          echo<<<data
            ...
            <button type="button" class="btn btn-outline-dark shadow-none" data-bs-toggle="modal"  data-bs-target="#registerModalkkk">
              <a class="nav-link" href="registration/registration.php">Register</a>
          </button>
          data;
       }
    ...
    <form id="register-form">
      ...
      <div class="modal-body">
        <span class="rounded-pill bg-light tecxt-dark mb-3 text-wrap lh-base">
          Note: Ensure that the information you provide aligns with the details on your identification documents.
        </span>
          <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-md-6 p-0 mb-3">
                      ...
                      <!-- 
                                <div class="col-md-6 p-0 mb-3">
                    <label class="form-label">Date of birth</label>
                    <input name="dob" type="date" class="form-control shadow-none" required onblur="calculateAge(this.value)">
                </div>
